// Test script to verify live exercise data from Supabase
import { ExerciseService } from './src/lib/exercise.service.js';
...
async function testLiveExercises() {
  ...
  try {
    ...
    console.log(`✅ Featured exercises: ${featuredResult.exercises.length}`);
