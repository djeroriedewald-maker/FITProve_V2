-- Migration: Workout Creator Schema
...
CREATE INDEX IF NOT EXISTS idx_custom_workouts_featured ON public.custom_workouts(is_featured) WHERE is_featured = true;
CREATE INDEX IF NOT EXISTS idx_custom_workouts_tags ON public.custom_workouts USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_custom_workouts_muscle_groups ON public.custom_workouts USING GIN(primary_muscle_groups);

CREATE INDEX IF NOT EXISTS idx_custom_workout_exercises_workout ON public.custom_workout_exercises(custom_workout_id);
CREATE INDEX IF NOT EXISTS idx_custom_workout_exercises_exercise ON public.custom_workout_exercises(exercise_id);
CREATE INDEX IF NOT EXISTS idx_custom_workout_exercises_order ON public.custom_workout_exercises(custom_workout_id, order_index);

CREATE INDEX IF NOT EXISTS idx_workout_sessions_user ON public.workout_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_workout_sessions_workout ON public.workout_sessions(custom_workout_id);
CREATE INDEX IF NOT EXISTS idx_workout_sessions_status ON public.workout_sessions(status);
CREATE INDEX IF NOT EXISTS idx_workout_sessions_completed ON public.workout_sessions(completed_at) WHERE completed_at IS NOT NULL;

CREATE INDEX IF NOT EXISTS idx_workout_exercise_results_session ON public.workout_exercise_results(workout_session_id);
CREATE INDEX IF NOT EXISTS idx_workout_exercise_results_exercise ON public.workout_exercise_results(exercise_id);

CREATE INDEX IF NOT EXISTS idx_workout_likes_user ON public.workout_likes(user_id);
CREATE INDEX IF NOT EXISTS idx_workout_likes_workout ON public.workout_likes(custom_workout_id);
...
-- Create trigger for updating workout stats
...
-- Create trigger for incrementing use count
...
-- View for workout details with exercise count and stats
...
-- View for popular public workouts
CREATE OR REPLACE VIEW public.popular_workouts AS
SELECT 
  wd.*
