-- Migration: Complete Social Features (Comments, Ratings, Favorites, Follows, Notifications) - FIXED
...
-- Index for notifications (now is_read column definitely exists)
...
-- MIGRATION COMPLETE
-- ============================================
-- Run VERIFY-SOCIAL-MIGRATION.sql to confirm everything worked!