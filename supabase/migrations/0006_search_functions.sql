-- Add Full-Text Search Function for Exercises
-- This migration adds advanced search capabilities with ranking and relevance scoring
...
SET search_vector = to_tsvector('english', 
    ...
    COALESCE(array_to_string(instructions, ' '), '') || ' ' ||
...
CREATE TRIGGER exercise_search_vector_trigger
...
CREATE INDEX IF NOT EXISTS idx_exercises_name_lower ON exercises USING btree(LOWER(name));
